...
[![GitHub Stars](https://img.shields.io/github/stars/afzalsayed96?style=social)](https://github.com/afzalsayed96)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Afzal%20Sayed-blue?logo=linkedin)](https://www.linkedin.com/in/afzalsayed96/)
[![Medium](https://img.shields.io/badge/Medium-@afzalsayed96-black?logo=medium)](https://medium.com/@afzalsayed96)
[![Hashnode](https://img.shields.io/badge/Hashnode-afzalsayed96-2962FF?logo=hashnode&logoColor=white)](https://afzalsayed96.hashnode.dev)
[![HackerOne](https://img.shields.io/badge/HackerOne-skyn3t-494649?logo=hackerone&logoColor=white)](https://hackerone.com/skyn3t)
...
- **Spectrum — SSR flicker / double-loading investigation**  
  ...
  [PR #5320](https://github.com/withspectrum/spectrum/pull/5320)
...
- **Cal.com — duplicate API call performance fix**  
  ...
  [PR #9700](https://github.com/calcom/cal.com/pull/9700)
...
- **Netlify / Next.js — dynamic import + serverless trace issue**  
  ...
  [Issue #121](https://github.com/netlify/next-on-netlify/issues/121)
...
- **Netlify / Next.js — optional catch-all routing edge case**  
  ...
  [Issue #76](https://github.com/netlify/next-on-netlify/issues/76)
...
- **Remotion — sequence API improvement**  
  ...
  [PR #1507](https://github.com/remotion-dev/remotion/pull/1507)
...
- **Evidence.dev — Query Viewer table scrolling**  
  ...
  [PR #465](https://github.com/evidence-dev/evidence/pull/465)
...
- **Uber Base Web — design-system contribution**  
  ...
  [PR #2580](https://github.com/uber/baseweb/pull/2580)
...
- **Stitches — frontend tooling / design-system ecosystem**  
  ...
  [PRs](https://github.com/stitchesjs/stitches/pulls?q=is%3Apr+author%3Aafzalsayed96)
...
- [Evidence.dev PRs](https://github.com/evidence-dev/evidence/pulls?q=is%3Apr+author%3Aafzalsayed96)
- [Remotion PRs](https://github.com/remotion-dev/remotion/pulls?q=is%3Apr+author%3Aafzalsayed96)
- [Base Web PRs](https://github.com/uber/baseweb/pulls?q=is%3Apr+author%3Aafzalsayed96)
- [Stitches PRs](https://github.com/stitchesjs/stitches/pulls?q=is%3Apr+author%3Aafzalsayed96)
- [Cal.com PRs](https://github.com/calcom/cal.com/pulls?q=is%3Apr+author%3Aafzalsayed96)
- [Netlify Next-on-Netlify Issues](https://github.com/netlify/next-on-netlify/issues?q=author%3Aafzalsayed96)
...
- [Medium](https://medium.com/@afzalsayed96)
- [Hashnode](https://afzalsayed96.hashnode.dev)
...
- [HackerOne: skyn3t](https://hackerone.com/skyn3t)
...
- LinkedIn: [linkedin.com/in/afzalsayed96](https://www.linkedin.com/in/afzalsayed96/)
- GitHub: [github.com/afzalsayed96](https://github.com/afzalsayed96)
- Medium: [medium.com/@afzalsayed96](https://medium.com/@afzalsayed96)
- Hashnode: [afzalsayed96.hashnode.dev](https://afzalsayed96.hashnode.dev)
